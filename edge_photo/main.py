...
tf.app.flags.DEFINE_string('data_path1', 'edge_shoe_64_2w.tfrecords', """Path to the lsun data file""")
tf.app.flags.DEFINE_string('data_path2', 'color_shoe_64_2w.tfrecords', """Path to the lsun data file""")
