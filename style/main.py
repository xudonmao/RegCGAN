...
tf.app.flags.DEFINE_string('data_path1', '../../../data/photo_130.tfrecords', """Path to the lsun data file""")
tf.app.flags.DEFINE_string('data_path2', '../../..//data/monet_130.tfrecords', """Path to the lsun data file""")
