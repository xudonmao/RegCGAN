...
tf.app.flags.DEFINE_integer('image_size', '112', """output size""")

tf.app.flags.DEFINE_string('data_path1', './align_female_no_glass_112.tfrecords', """Path to the lsun data file""")
tf.app.flags.DEFINE_string('data_path2', './align_male_no_glass_112.tfrecords', """Path to the lsun data file""")
