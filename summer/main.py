...
tf.app.flags.DEFINE_string('data_path1', 'summer_130.tfrecords', """Path to the lsun data file""")
tf.app.flags.DEFINE_string('data_path2', 'winter_130.tfrecords', """Path to the lsun data file""")
