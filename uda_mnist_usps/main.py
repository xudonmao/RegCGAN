...
tf.app.flags.DEFINE_integer('test_sample_size', '10000', """sample number""")
tf.app.flags.DEFINE_integer('test_batch_size', '100', """batch size""")
tf.app.flags.DEFINE_integer('test_sample_size2', '2007', """sample number""")
tf.app.flags.DEFINE_integer('test_batch_size2', '223', """batch size""")
